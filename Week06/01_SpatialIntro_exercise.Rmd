...
r_squared <- runif(n_points, 0, radius)
...
# Run a quadrat test
quadrat.test(p_regular, alternative = "regular") #EBT: Tester om den er regulær??, hvis pværdien er lav nok konfirmerer det at den er regulær. alternative kan ses som: distribution.
```
EBT: p-værdi = er værdien under 0,05
